    ...
    Column(modifier = Modifier.fillMaxSize()) {
        TopAppBar(
            ...
            navigationIcon = {
                IconButton(onClick = { navController.popBackStack() }) {
                    Icon(imageVector = androidx.compose.material.icons.Icons.Filled.ArrowBack, contentDescription = "Назад")
                }
            }
        )
        ...
        Box(
            ...
            IconButton(
                ...
                Icon(imageVector = androidx.compose.material.icons.Icons.Filled.ArrowForward, contentDescription = "Вперёд")
            }
        }
    }
}
