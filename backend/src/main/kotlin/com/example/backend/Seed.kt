...
internal val appsSeed = listOf(
    ...
    SeedApp(
        ...
        category = "Финансы",
        ratingAge = "12+",
        shortDesc = "Некастодиальный мультикошелёк для криптовалют и NFT с Web3-браузером и стейкингом.",
        fullDesc =
            "Trust Wallet — безопасный некастодиальный кошелёк для управления криптоактивами и NFT. " +
                    "Поддерживаются сотни сетей и тысячи токенов, импорт по seed-фразе, локальное шифрование и бэкапы. " +
                    "Есть стейкинг, свопы, встроенный Web3-браузер для dApp и уведомления о транзакциях. " +
                    "Удобные экраны портфеля и истории, быстрая отправка и приём средств.",
